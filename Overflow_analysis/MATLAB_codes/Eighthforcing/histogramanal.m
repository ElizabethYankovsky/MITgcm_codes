...
%Initial:
Si=sq(ncread('Eighth5.nc','S',[1 1 1 40],[Inf Inf Inf 1]));
Ti=sq(ncread('Eighth5.nc','Temp',[1 1 1 40],[Inf Inf Inf 1]));

densityi = densmdjwf(Si,Ti,zeros(1280,240));
%Last time step:
Sf=sq(ncread('Eighth6.nc','S',[1 1 1 80],[Inf Inf Inf 1]));
Tf=sq(ncread('Eighth6.nc','Temp',[1 1 1 80],[Inf Inf Inf 1]));
