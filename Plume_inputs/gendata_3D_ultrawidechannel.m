...
forcingwidth = 10000.0; %in meters (original was 2km)
forcingdepth = 5.0;
time = 0:0.4:74.4; %in hours
ntime= 74.4/0.4+1; nyf=100; nzf=250;
...
U_forcing = blank; U_forcing(160:259,:,:)=U_f; %U velocity at western b.c.
...
S_forcing = blank+34.0; S_forcing(160:259,1:50,:)=S_f; %Salinity at western b.c.
...
d(1, 160:259)=-5.0; %Open the channel at the left boundary.
d(1:100,260:409)= fliplr(triangle);
