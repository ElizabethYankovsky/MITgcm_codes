...
% Dimensions of grid
%nx=80;
nx=1280; %320 previously
ny=1;
nz=240; %60 previously
...
% Temperature profile
i = 1:1:nz;
Tref = 1.5516 - 1.5414*(tanh(i/(2*179.2610))+1); %2*179.2610 for doubled res
...
%Salinity profile
i = 1:1:nz;
Sref=33.9831+0.4654*(tanh(i/(2*17.9459))+1); %2* 17.9459 for doubled res, etc.
